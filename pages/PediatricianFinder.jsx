...
export default function PediatricianFinder() {
  const navigate = useNavigate();

  return (
    <div className="min-h-screen bg-white text-blue-600 p-4 pt-20 font-comic">
      <h2 className="text-2xl font-bold text-blue-600 mb-6">Pediatrician Finder</h2>
      <div className="bg-gradient-to-r from-blue-100 to-blue-50 rounded-xl p-6">
        <p className="text-blue-500">Pediatrician Finder coming soon! Find trusted doctors nearby.</p>
        <button
